...
func (renderer *PxCanvasRenderer) MinSize() fyne.Size {
	return renderer.pxCanvas.DrawingAreas
}
...
func (renderer *PxCanvasRenderer) Refresh() {
	...
	canvas.Refresh(renderer.pxCanvas)
}
